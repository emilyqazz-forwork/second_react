 ...
 */
export const getListProblemsUrl = () => {
  return `/api/chickode/problems`;
};

export const listProblems = async (
  options?: RequestInit,
): Promise<Problem[]> => {
  return customFetch<Problem[]>(getListProblemsUrl(), {
    ...options,
    method: "GET",
  });
};

export const getListProblemsQueryKey = () => {
  return [`/api/chickode/problems`] as const;
};
...
>(options?: {
  ...
  const queryKey = queryOptions?.queryKey ?? getListProblemsQueryKey();

  const queryFn: QueryFunction<Awaited<ReturnType<typeof listProblems>>> = ({
    signal,
  }) => listProblems({ signal, ...requestOptions });
...
>(options?: {
  ...
  const queryOptions = getListProblemsQueryOptions(options);
 ...
 */
export const getGenerateHintUrl = () => {
  return `/api/chickode/hint`;
};
...
export const generateHint = async (
  ...
  return customFetch<HintResponse>(getGenerateHintUrl(), {
    ...options,
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
...
export const getGenerateHintMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof generateHint>>,
    TError,
  ...
  TContext
> => {
  const mutationKey = ["generateHint"];
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
  ...
  > = (props) => {
    ...
    return generateHint(data, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type GenerateHintMutationResult = NonNullable<
  Awaited<ReturnType<typeof generateHint>>
>;
export type GenerateHintMutationBody = BodyType<HintRequest>;
export type GenerateHintMutationError = ErrorType<unknown>;
...
>(options?: {
  ...
  TContext
> => {
  return useMutation(getGenerateHintMutationOptions(options));
};
...
export const submitAnswer = async (
  ...
  return customFetch<SubmitResponse>(getSubmitAnswerUrl(), {
    ...options,
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
...
export type SubmitAnswerMutationResult = NonNullable<
  Awaited<ReturnType<typeof submitAnswer>>
>;
export type SubmitAnswerMutationBody = BodyType<SubmitRequest>;
